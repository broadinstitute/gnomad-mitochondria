...
from mitochondria.annotation_descriptions import add_descriptions, adjust_descriptions
...
def filter_by_contamination(
    ...
    epsilon = 0.000001
    border_samples = hl.literal(
        input_mt.aggregate_cols(
            hl.agg.filter(
...
def add_variant_annotations(
    ...
    mt = mt.annotate_rows(
        alt_haps=hl.zip_with_index(mt.hap_AC)
