...
def in_mitomap(other_databases_path):
...
def hmtvar_annotations(insilicos_path):
    ...
    with open(insilicos_path + "hmtvar_annotations.txt") as hmtvar:
        ...
        for row in hmtvar:
            ...
            if len(row["HmtVar"]) > 3:
                ...
                insilico = annotation["pathogenicity"]
...
def parse_vcf(matches_samples, gnomAD_path):
...
def consequences(synthetic_vcf_path):
...
def in_helix(other_databases_path):
